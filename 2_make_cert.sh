...
$ELASTICSEARCH_PATH/bin/elasticsearch-certutil cert --name host --ip $LOGSTASH_SERVER_IP_ADDRESSES --out $SSL_CERTIFICATES_PATH/ssl_certificates/certificates.zip  --keep-ca-key --pem
